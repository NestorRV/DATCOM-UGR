...
def bidirectional_lstm_rnn(embeddings_path, train_xs, train_ys, test_xs, test_ys=None, verbose=1):
    own_set_seed()
    ...
    nn_model.add(Bidirectional(LSTM(100, return_sequences=True, dropout=0.25, recurrent_dropout=0.1)))
